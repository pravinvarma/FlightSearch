(function (angular) {
    ...
    flightSearchController.$inject = ['$http', 'constants', 'dataService', 'utilityServices', 'popupService', 'sourceDestCheckPopupConstant'];

    function flightSearchController($http, constants, dataService, utilityServices, popupService, sourceDestCheckPopupConstant) {
        var vm = this;
        var airport = [];
        vm.returnDate = "";
        vm.flightData = false;
